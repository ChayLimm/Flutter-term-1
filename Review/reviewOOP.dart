...
class House{
  ...
  Floor floor;
  Chimney? chimney;
  House({required this.door, required this.window, required this.roof, required this.floor, this.chimney});
...
void main(){
  ...
  Chimney c1 = new Chimney(1);
  House house1 = House(door: d1, window: w1, roof: r1, floor: f1, chimney: c1);
